  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Platform colors
        platform: {
          db2: "hsl(var(--platform-db2))",
          cics: "hsl(var(--platform-cics))",
          ims: "hsl(var(--platform-ims))",
          files: "hsl(var(--platform-files))",
          platform: "hsl(var(--platform-platform))",
          observability: "hsl(var(--platform-observability))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
